...
def get_leave_card_html(r: dict, is_single_view: bool = False) -> str:
    ...
    return f"""<div class="live-task-card" data-single-view="{'true' if is_single_view else 'false'}" style="background: #faf5ff; border: 1px solid #e9d5ff; border-left: 4px solid #a855f7; border-radius: 8px; padding: {card_padding}; box-shadow: 0 1px 3px rgba(168,85,247,0.08);"><div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 6px;"><div><span style="font-size: 13.5px; font-weight: 700; color: #581c87;">👤 {w_name}{title_str}</span><span style="background: #f3e8ff; color: #7e22ce; border: 1px solid #d8b4fe; padding: 1px 5px; border-radius: 4px; font-size: 10px; font-weight: 800; margin-left: 4px;">🏖️ {leave_type}</span></div><span style="background-color: #f3e8ff; color: #7e22ce; border: 1px solid #d8b4fe; border-radius: 6px; padding: {time_badge_padding}; font-size: 10.5px; font-weight: 700; white-space: nowrap;">{st_t}~{ed_t}</span></div><div style="font-size: {client_font_size}; color: #6b21a8; font-weight: 700; margin-bottom: 4px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">🏢 🏖️ {leave_type} (공식 휴가)</div><div style="position: relative; overflow: hidden; background: #e9d5ff; border-radius: 6px; border: 1px solid #d8b4fe; margin-bottom: 5px; min-height: 28px; display: flex; align-items: center;"><div class="live-progress-bar live-progress-fill" style="position: absolute; left: 0; top: 0; bottom: 0; width: 100%; background: linear-gradient(90deg, #9333ea 0%, #a855f7 100%); border-radius: 5px;"></div><div style="position: relative; z-index: 2; width: 100%; display: flex; justify-content: space-between; align-items: center; padding: 3px 6px; font-size: 11px; font-weight: 600; color: #ffffff; text-shadow: 0 1px 2px rgba(0,0,0,0.6); gap: 4px;"><span style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap; max-width: 70%;">{subj}</span><span class="live-pct-badge" style="font-weight: 700; color: #ffffff; font-size: 10px; white-space: nowrap; background: rgba(0,0,0,0.35); padding: 1px 4px; border-radius: 4px;">100% 완료</span></div></div><div style="display: flex; justify-content: space-between; font-size: 10.5px; color: #7e22ce; font-weight: 600; margin-top: 2px;"><span>⏱️ 인정 {dur_h}h</span><span>✅ 부재 등록 완료</span></div></div>"""
